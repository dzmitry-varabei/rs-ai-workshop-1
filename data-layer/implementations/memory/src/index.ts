/**
 * In-memory Infrastructure Package Exports
 * 
 * This package provides in-memory implementations of domain repositories
 * for testing and development without external dependencies.
 */

export { MemoryWordRepository } from './repositories/MemoryWordRepository.js';
